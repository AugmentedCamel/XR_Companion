...
public class TextFade : MonoBehaviour
{
    ...
    private bool FadeActiveTrigger = false;
    private bool FadeNotActiveTrigger = false;
    ...
    public void SetText(string text, bool IsFading)
    {
        m_TextComponent.text = text;
        if (IsFading)
        {
            FadeActiveTrigger = true;
        }
        else
        {
            FadeNotActiveTrigger = true;
        }
    }
    
    public void TranscriptoinOutput(string text)
    {
        SetText(text, false);
    }
    /// <summary>
